                     ...
                     <div class="navbar-header">
                      ...
                      <div class="collapse navbar-collapse" id="menuTransformadores">
                        <ul class="nav nav-pills NavTransformadores">
                          <li>
                          <a href="/Transformadores/pt">O Prêmio</a>
                          </li>
                          <li class="dropdown ">
                          <a href="#">Categorias<strong class="hidden-desktop pull-right icon-chevron-down icon-white"></strong></a>
                          <ul class="dropdown-menu">
                              <li>
                              <a href="/Transformadores/pt/InvestimentoSocialPrivado">Investimento Social Privado</a>
                              </li>
                              <li>
                              <a href="/Transformadores/pt/Negocios">Negócios</a>
                              </li>
                          </ul>
                          </li>
                          <li class="dropdown ">
                          <a href="#">Experiências<strong class="hidden-desktop pull-right icon-chevron-down icon-white"></strong></a>
                          <ul class="dropdown-menu">
                              <li>
                              <a href="/Transformadores/pt/Experiencias/2015">2015</a>
                              </li>
                              <li>
                              <a href="/Transformadores/pt/Experiencias/2013">2013</a>
                              </li>
                          </ul>
                          </li>
                          <li>
                          <a href="/Transformadores/pt/juri">Júris</a>
                          </li>
                      </ul>
                    </div>
                  </div>
